 ...
 *
 * Demo note:
 * - `POST /api/departments` is currently allowed without auth ("demo bypass")
 *   so teachers/admins can create dropdown values during the demo.
 * - Query endpoints are open to support initial page loads.
 */
...
// Demo bypass: department creation is allowed without auth.
